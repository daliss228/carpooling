...
class AlertWidget extends StatelessWidget {
  ...
  const AlertWidget({Key key, this.title, this.message}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: AlertDialog(
        ...
        title: Text(title, style: TextStyle(fontSize: 20.0, fontFamily: 'WorkSansSemiBold', fontWeight: FontWeight.w300)),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: <Widget>[
            Icon(Icons.sentiment_dissatisfied, size: 90.0),
            SizedBox(height: 20.0),
            Text(message, style: TextStyle(fontSize: 15.0, fontFamily: 'WorkSans', fontWeight: FontWeight.w300)),
          ],
        ),
        actions: <Widget>[
          FlatButton(onPressed: ()=> Navigator.of(context).pop(), child: Text('OK', style: TextStyle(fontSize: 20.0, fontFamily: 'WorkSansSemiBold', fontWeight: FontWeight.w300, color: Color(0xFF0393A5))))
